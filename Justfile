...
variant_repos := '(
    ...
    [bazzite-nvidia-open]="ghcr.io/ublue-os/bazzite-nvidia-open"
)'
...
[arg('variant', pattern='silverblue|kinoite|bootc|secureblue-silverblue|secureblue-kinoite|bazzite-dx|bazzite-dx-gnome|bazzite-nvidia-open')]
build variant:
    #!/bin/bash
    set -euo pipefail
